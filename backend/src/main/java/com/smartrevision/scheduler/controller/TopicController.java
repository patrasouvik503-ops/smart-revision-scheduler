...
import com.smartrevision.scheduler.api.UpdateNotesRequest;
...
public class TopicController {
    ...
    public TopicResponse updateNotes(@PathVariable Long id, @RequestBody UpdateNotesRequest request, HttpServletRequest httpRequest) {
        CurrentUser user = (CurrentUser) httpRequest.getAttribute(AuthInterceptor.CURRENT_USER_ATTRIBUTE);
        return topicService.updateNotes(user.id(), id, request.notes());
    }
